...
<div id="getting_started" class="stacy-tab-pane active">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<h1 class="stacy-info-title text-center"><?php echo esc_html__('About the Stacy theme','stacy'); ?></h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
				<div class="stacy-tab-pane-half stacy-tab-pane-first-half">
					...
					<h1 style="margin-top: 73px !important; font-size: 2em !important; background: #0085ba;border-color: #0073aa #006799 #006799; color: #fff; padding: 5px 10px; line-height: 40px;"><?php esc_html_e( "Getting Started", 'stacy' ); ?></h1>
					<div>
					...
					<p><a target="_blank" href="<?php echo esc_url( admin_url( 'customize.php' ) ); ?>" class="button button-primary" style="padding: 3px 15px;height: 40px; font-size: 16px;"><?php esc_html_e( 'Go to the Customizer','stacy');?></a></p>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="stacy-tab-pane-half stacy-tab-pane-first-half">
				<img class="img-responsive" src="<?php echo esc_url( STACY_ST_TEMPLATE_DIR_URI ) . '/admin/img/stacy.png'; ?>" alt="<?php esc_attr_e( 'Stacy theme', 'stacy' ); ?>" />
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-6">
				<div class="stacy-tab-pane-half stacy-tab-pane-first-half">
					...
					<p class="info-text"><?php echo esc_html__('Theme Support','stacy'); ?></p></a>
				</div>
			</div>
			<div class="col-md-6">
				<div class="stacy-tab-pane-half stacy-tab-pane-first-half">
			...
			<div class="col-md-6">
				<div class="stacy-tab-pane-half stacy-tab-pane-first-half">
					...
					<p class="info-text"><?php echo esc_html__('Changelog','stacy'); ?></p></a>
				</div>
			</div>
		</div>
	</div>
